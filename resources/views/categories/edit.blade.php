        ...
        <div class="max-w-lg mx-auto bg-white p-6 border border-gray-300">
            ...
            <form method="POST" action="{{ route('categories.update', $category->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input class="border border-gray-400 p-2 w-full text-black" type="text" name="name" value="{{ $category->name }}" required>
                </div>
    
                <div class="mb-6">
                    <label class="block mb-1 font-semibold text-gray-700">Description</label>
                    <textarea class="border border-gray-400 p-2 w-full text-black" name="description" rows="4">{{ $category->description }}</textarea>
                </div>
